...
const DAY: Palette = {
  ...
  ink: '#0C3A42',
  inkSoft: '#46707A',
  title: ['#015866', '#037A8A', '#029FB1', '#01C1D5'],
  accent: '#029FB1',
  silhouette: '#037A8A',
...
const PALETTES: Record<Phase, Palette> = {
  dawn: {
    ...
    title: ['#015866', '#0E7C86', '#5FAFB4', '#E7A98F'],
    accent: '#E9B9A5',
    silhouette: '#7E93A0',
    stars: 12,
  },
  ...
  golden: {
    ...
    title: ['#015866', '#0A7F84', '#C79A4D', '#E0B15E'],
    accent: '#D9A441',
    silhouette: '#B08A4A',
  },
  dusk: {
    ...
    ink: '#FFF6EC',
    inkSoft: '#E4C6BD',
    title: ['#FFE9C8', '#FFC98A', '#8FE3F0', '#01C1D5'],
    accent: '#F0C48A',
    silhouette: '#2A2E46',
  ...
  night: {
    ...
    ink: '#EAF9FB',
    inkSoft: '#93CBD6',
    title: ['#8FE3F0', '#01C1D5', '#7FD8E4', '#FFE3B0'],
    accent: '#F2C879',
    silhouette: '#00232C',
