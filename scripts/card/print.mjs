...
/* ── front: the mark on white, the sweep beneath ── */
.front{background:#fff;display:flex;flex-direction:column;align-items:center;justify-content:center}
.mark{height:21mm;width:auto;display:block}
.name{margin-top:4.6mm;font-family:'P';font-weight:700;font-size:7.6mm;color:${WT.ink};
  line-height:1;letter-spacing:1.15mm;text-transform:uppercase;padding-left:1.15mm}
.tag{margin-top:2.4mm;font-family:'P';font-weight:600;font-size:2.5mm;color:${WT.ink};
...
.back{background:linear-gradient(140deg,#0B1235 0%,#241A6B 46%,#5A1FA8 100%);color:#fff;
  padding:${BLEED + SAFE}mm ${BLEED + SAFE}mm}
