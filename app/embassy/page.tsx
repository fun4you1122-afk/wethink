...
import TypedTitle from '@/components/embassy/TypedTitle'
      ...
      <div className="relative z-10 mx-auto max-w-[780px] px-5 pb-24 pt-24 sm:pt-28">
        ...
        <header className="relative text-center">
          ...
          <DepthScene strength={1}>
            ...
            <DepthLayer z={110}>
              {/* The title types itself, then the gradient takes over and the
                  sheen starts travelling. The halo sits on this wrapper: a
                  filter on the element that carries background-clip:text
                  repaints the box and erases the gradient. */}
              <div
                style={{
                  filter:
              ...
              >
                <motion.h1
                  className="mt-1 text-[clamp(38px,11vw,78px)] font-semibold leading-[1.05] tracking-tight"
                ...
                >
                  <TypedTitle
                    text={EVENT.title}
                    solid={tod.title[1]}
                    gradient={`linear-gradient(100deg, ${tod.title[0]} 0%, ${tod.title[1]} 26%, ${tod.title[2]} 44%, #4FD3E4 52%, ${tod.title[2]} 60%, ${tod.title[3]} 86%, ${tod.title[1]} 100%)`}
                  />
                </motion.h1>
              </div>
            </DepthLayer>
